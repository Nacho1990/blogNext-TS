  ...
  return (
    <main>
      ...
      <article className="max-w-3xl mx-auto p-5">
        ...
        <h2 className="text-xl font-light text-gray-400 mb-2">
          {post.description}
        </h2>
      ...
      <div className="flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
        <h3 className="text-3xl font-bold" >Gracias por comentar!</h3>
        <p>Tu comentario sera publicado cuando esté aprobado!</p>
      </div>
      :
...
export const getStaticProps: GetStaticProps= async ({params}) => {
  const query = `*[_type == "post" && slug.current == "primer-post"][0]{
    _id,
    _createdAt,
    title,
    author-> {
